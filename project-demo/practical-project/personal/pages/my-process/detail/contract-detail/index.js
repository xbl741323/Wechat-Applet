...
import { getContractDetail, auditLog, auditPaperContract } from "../../../../../utils/api/process";
import { contractStatus } from "../../../../../utils/common/contract";
import { getOrderInfo } from "../../../../../utils/api/contract";
import { filterArea } from "../../../../../utils/clue/clue"
const app = getApp();
Page({
  ...
  getdetail(id){
    getContractDetail({taskId: id}).then(res=>{
