...
const app = getApp();
import { getDetail, getOrderInfo, getLogInfo } from "../../../../utils/api/contract";
import * as CodeMsg from "../../../../utils/common/codeMsg";

import { filterArea } from "../../../../utils/clue/clue"
import { category } from "../../../../utils/order/order";
...
Page({
  ...
  // 查看合同
  checkContract() {
    let contractFileUrl = this.data.contractInfo.signUrl
